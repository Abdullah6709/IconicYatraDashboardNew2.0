        ...
        <Box sx={{ display: "flex", gap: 2 }}>
          ...
          <Box sx={{ flex: 1 }}>
            ...
            <Box sx={{ p: 1, border: "1px solid #2196f3" }}>
              <Typography variant="body2">
                <strong>{invoiceData?.name || "Amit Jainwal"}</strong>
              </Typography>
              <Typography variant="body2">
          ...
          <Box sx={{ flex: 1 }}>
            ...
            <Box sx={{ p: 1, border: "1px solid #2196f3" }}>
              <Typography variant="body2">
                Place of supply: {invoiceData?.placeOfSupply || "Uttar Pradesh"}
              </Typography>
              <Typography variant="body2">
            ...
            <Table size="small">
              <TableBody>
                ...
                <TableRow>
                  ...
                  <TableCell>{invoiceData?.particular || "abc"}</TableCell>
                  <TableCell></TableCell>
                  <TableCell align="right">500</TableCell>
                  <TableCell align="right">90 (18%)</TableCell>
