...
const InvoiceFormEdit = ({ initialData }) => {
  ...
  const formik = useFormik({
    initialValues: {
      ...
      invoiceNo: initialData?.invoiceNo || "I-202517",
      invoiceDate: initialData?.invoiceDate || "",
      dueDate: initialData?.dueDate || "",
      stateOfSupply: initialData?.stateOfSupply || "",
      taxType: initialData?.taxType || "withTax",
      ...
      invoiceValuePurchase: initialData?.invoiceValuePurchase || "",
