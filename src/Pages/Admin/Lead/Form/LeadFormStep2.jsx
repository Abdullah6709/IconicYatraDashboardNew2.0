...
const LeadFormStep2 = ({ onBack, leadData }) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      console.log("Submitted Step 2 values:", values);
      // TODO: combine with leadData and send to API, etc.
    },
  });
  ...
  // ---- Fix: define renderTextInputs used in the JSX ----
        ...
        <Box mt={2} p={2} border={1} borderRadius={2} borderColor="grey.300">
          ...
          <LocalizationProvider dateAdapter={AdapterDayjs}>
            <Grid container spacing={2}>
              ...
              {renderTextInputs.slice(0, 4).map(({ name, label }) => (
                  ...
                  <DatePicker
                    ...
                    renderInput={(params) => (
                      <TextField
                        ...
                        {...params}
                        error={
                          touched.arrivalDate && Boolean(errors.arrivalDate)
                        }
